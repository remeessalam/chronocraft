    ...
    <div className="text-black max-w-screen overflow-x-hidden">
      ...
      <div className="max-w-screen overflow-hidden">
        <section className="w-full grid lg:grid-cols-[60%_40%] items-end relative">
          ...
          >
            ...
            />
            <div
              className="z-10 bg-gradient-to-b from-primary to-secondary w-full p-5 grid md:grid-cols-3 gap-5 lg:w-[70vw] lg:-translate-x-[30vw]"
              // data-aos="fade-left"
            >
              ...
              <div className="flex flex-col gap-2 text-white items-start p-5 md:pl-10">
                ...
                <img
                  src={recognition}
                  alt=""
                  className="h-[4rem] w-[4rem] text-orange-400 grayscale"
                />
      ...
      <div className="wrapper bg-white paddingtop paddingbottom px-4 sm:px-6 lg:px-8 py-16">
        <div className="max-w-7xl mx-auto">
          <h1
            data-aos="fade-up"
            className="main-heading max-w-[60rem] mx-auto text-start sm:text-center !text-primary"
          >
            Portfolio
          </h1>
