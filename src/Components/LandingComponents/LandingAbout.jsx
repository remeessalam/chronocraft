  ...
  return (
    <div id="aboutus" className="bg-white wrapper py-8">
      ...
      <div className="text-center mb-12">
        ...
        <h1 className="main-heading !text-primary" data-aos="fade-up">
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="space-y-6 mt-16 sm:mt-0">
          ...
          <button
            className="bg-primary text-white px-8 py-3 rounded-lg font-medium hover:bg-opacity-90 transition-colors"
            data-aos="fade-left"
            onClick={() =>
