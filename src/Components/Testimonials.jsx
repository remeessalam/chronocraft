...
import testiImg from "../assets/image/testimonials/testimonials-bg.png";
import users from "../assets/image/users-grp.png";
...
const Testimonials = () => {
  ...
  return (
    <div
      id="reviews"
      className="min-h-[50vh] sm:py-0 pb-14  w-full bg-cover bg-no-repeat bg-bottom flex items-center z-10"
      ...
      <div className="wrapper grid lg:grid-cols-2 gap-10 w-full">
        ...
        >
          {testimonials.map((item) => (
            <div
              key={item.id}
              className="testimonial-item bg-white opacity-0 absolute inset-0 w-full h-full flex flex-col justify-center p-5 rounded-3xl border-2 border-primary shadow-2xl"
            >
              <img
                width="75"
                height="75"
