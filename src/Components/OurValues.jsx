        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-[2rem]">
          {values.map((value, index) => (
            ...
            >
              ...
              <div>
                <h3 className="text-xl font-bold text-white mb-2 font-candal">
                  {value.title}
                </h3>
              ...
              {workProcess.map((process, index) => (
                ...
                >
                  <div className="bg-white rounded-xl pl-6 pr-14 py-10 shadow-lg relative h-full">
                    ...
                    >
                      <div className="h-14 w-14 sm:w-16 sm:h-16 bg-primary rounded-full flex items-center justify-center text-white">
